"""
Django settings for Arhitektuuri Labor  project.
...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[Arhitektuuri Labor ] '  # subject prefix for managers & admins

SESSION_COOKIE_NAME = 'arhitektuurkaks_ssid'
...
ROOT_URLCONF = 'arhitektuurkaks.urls'

WSGI_APPLICATION = 'arhitektuurkaks.wsgi.application'
...
# Email config
DEFAULT_FROM_EMAIL = "Arhitektuuri Labor  <info@TODO.com>"
SERVER_EMAIL = "Arhitektuuri Labor  server <server@TODO.com>"
